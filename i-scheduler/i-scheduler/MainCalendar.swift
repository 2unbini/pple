...
struct MainCalendar: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            daysOfTheWeek
            Divider()
            ScrollableCalendarVGrid(calendarConfig: calendarConfig) { month, date, width in
...
//    var years: [Date] {
//        return calendar.generateDates(interval: calendarConfig.interval, dateComponents: DateComponents(month: 1, day: 1, hour: 0, minute: 0, second: 0))
//    }
